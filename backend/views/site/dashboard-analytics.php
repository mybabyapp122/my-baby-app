...
$students = \common\models\Student::find()->where(['IN','status',['active', 'pending']])->count();
$teachers = \common\models\User::find()->where(['IN','status',['active']])->andWhere(['role' => 'teacher'])->count();
$schools = \common\models\User::find()->where(['IN','status',['active']])->andWhere(['role' => 'school'])->count();

$plan_one_schools = \common\models\User::find()->where(['IN','status',['active']])->andWhere(['role' => 'school'])->andWhere(['plan_id' => 1])->count();
$plan_two_schools = \common\models\User::find()->where(['IN','status',['active']])->andWhere(['role' => 'school'])->andWhere(['plan_id' => 2])->count();
$plan_three_schools = \common\models\User::find()->where(['IN','status',['active']])->andWhere(['role' => 'school'])->andWhere(['plan_id' => 3])->count();


$formatter = Yii::$app->formatter;
$sales = \common\models\Sale::getAllPaidInvoicesGeneratedBySystem();
$unpaid_sales = \common\models\Sale::getAllUnPaidInvoicesGeneratedBySystem();
                ...
                <div class="col-md-6">
                    <div class="card card-animate">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <p class="fw-medium text-muted mb-0"><?= Yii::t('app', 'Schools') ?></p>
                                    <h6 class="mt-4 ff-secondary fw-semibold"><?= $schools ?></h6>
                                </div>
                                <div>
                                    <div class="avatar-sm flex-shrink-0">
                                                <span class="avatar-title bg-success rounded-circle fs-2">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <p class="mb-0 text-muted"><span class="badge bg-light text-danger mb-0"><?= Yii::t('app', 'Trial Plan') ?></span> <?= $plan_one_schools ?></p>
                                    <p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"><?= Yii::t('app', 'Basic Plan') ?></span> <?= $plan_two_schools ?></p>
                                    <p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"><?= Yii::t('app', 'Premium Plan') ?></span> <?= $plan_three_schools ?></p>
                                </div>
                                <div>
                                    <div class="avatar-sm flex-shrink-0">
                                        <span class="avatar-title bg-success rounded-circle fs-2"><i class="bx bxs-user-detail"></i></span>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end card body -->
                ...
                <div class="col-md-6">
                    <div class="card card-animate">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <p class="fw-medium text-muted mb-0"><?= Yii::t('app', 'Paid Invoices') ?></p>
                ...
                <div class="col-md-6">
                    <div class="card card-animate">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <p class="fw-medium text-muted mb-0"><?= Yii::t('app', 'Pending Invoices') ?></p>
        ...
        <div class="row h-100">
            ...
            <div class="card">
                <div class="card-header border-0 align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Student Attendance Metrics</h4>
                    <div>
                    ...
                    <div class="row g-0 text-center">
                        <div class="col-12 col-sm-6">
                            <div class="p-3 border border-dashed border-start-0">
                                <h5 class="mb-1"><span class="counter-value" data-target="1400">0</span>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="p-3 border border-dashed border-start-0">
                                <h5 class="mb-1"><span class="counter-value" data-target="1500">0</span>
                                    <span class="text-success ms-1 fs-12">51%<i class="ri-arrow-right-down-line ms-1 align-middle"></i></span>
                                </h5>
                                <p class="text-muted mb-0">Absence Rate</p>
                            </div>
                        </div>
                        <!--end col-->
            ...
            <div class="card-body pt-0">
                ...
                <div class="mini-stats-wid d-flex align-items-center mt-3">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h6 class="mb-1">Result Announcement</h6>
                        <p class="text-muted mb-0">Grade 1 to Grade 4</p>
                    </div>
                ...
                <div class="mini-stats-wid d-flex align-items-center mt-3">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h6 class="mb-1">Casual Day</h6>
                        <p class="text-muted mb-0">All Grades</p>
                    </div>
                    <div class="flex-shrink-0">
                ...
                <div class="mini-stats-wid d-flex align-items-center mt-3">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <p class="text-muted mb-0">Lunch included</p>
                    </div>
                    <div class="flex-shrink-0">
                ...
                <div class="mini-stats-wid d-flex align-items-center mt-3">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h6 class="mb-1">Arts Show</h6>
                        <p class="text-muted mb-0">Grade 1</p>
                    </div>
                    <div class="flex-shrink-0">
    ...
    <div class="col-xxl-4">
        ...
        <div class="card card-height-100">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Registered Schools</h4>
                <div class="flex-shrink-0">
            ...
            <div class="card-body">
                ...
                <div class="px-2 py-2 mt-4">
                    <p class="mb-1">Madinah <span class="float-end">75%</span></p>
                    ...
                    <p class="mt-3 mb-1">Jeddah <span class="float-end">47%</span>
                    </p>
                    <div class="progress mt-2" style="height: 6px;">
                    ...
                    <p class="mt-3 mb-1">Riyadh <span class="float-end">82%</span></p>
                    <div class="progress mt-2" style="height: 6px;">
