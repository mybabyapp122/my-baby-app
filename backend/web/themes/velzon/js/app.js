...
(function () {
	...
	function setLanguage(lang) {
		if (document.getElementById("header-lang-img")) {
			if (lang == "en") {
				document.getElementById("header-lang-img").src = "/themes/velzon/images/flags/us.svg";
			} else if (lang == "sp") {
				document.getElementById("header-lang-img").src = "/themes/velzon/images/flags/spain.svg";
			} else if (lang == "gr") {
				document.getElementById("header-lang-img").src = "/themes/velzon/images/flags/germany.svg";
			} else if (lang == "it") {
				document.getElementById("header-lang-img").src = "/themes/velzon/images/flags/italy.svg";
			} else if (lang == "ru") {
				document.getElementById("header-lang-img").src = "/themes/velzon/images/flags/russia.svg";
			} else if (lang == "ch") {
				document.getElementById("header-lang-img").src = "/themes/velzon/images/flags/china.svg";
			} else if (lang == "fr") {
				document.getElementById("header-lang-img").src = "/themes/velzon/images/flags/french.svg";
			} else if (lang == "ar") {
				document.getElementById("header-lang-img").src = "/themes/velzon/images/flags/ae.svg";
			}
	...
	function getLanguage() {
		...
		request.open("GET", "/themes/velzon/lang/" + language + ".json");
	...
	function twoColumnMenuGenerate() {
		...
		if (defaultValues && (isTwoColumn == "twocolumn" || defaultValues["data-layout"] == "twocolumn")) {
			...
			ul.innerHTML = '<a href="#" class="logo"><img src="/images/mybaby/mb-logo-sm.png" alt="" height="65"></a>';
	...
	function initTwoColumnActiveMenu() {
		...
		if (currentPath) {
			...
			// Check if the body has the correct class for a two-column panel
			if (document.body.classList.contains("twocolumn-panel")) {
				var twoColumnMenu = document.getElementById("two-column-menu");

				// Ensure the two-column menu exists before querying it
				if (twoColumnMenu) {
					var activeLink = twoColumnMenu.querySelector('[href="' + currentPath + '"]');
					if (activeLink) {
					...
					if (elem.querySelectorAll(".notification-item").length > 0) {
						...
						if (!emptyNotificationElem) {
							...
							<div class="w-25 w-sm-50 pt-3 mx-auto">\
								<img src="/themes/velzon/images/svg/bell.svg" class="img-fluid" alt="user-pic">\
							</div>\
